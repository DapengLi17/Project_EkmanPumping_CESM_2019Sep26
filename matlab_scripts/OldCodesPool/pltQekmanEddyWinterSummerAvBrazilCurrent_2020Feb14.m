...
outfile1 = ['../data_after_manipulation/QekmanEddyWinterSummerAvBrazilCurrents_',date_str,'.txt'];
pic1 = ['../pics/QekmanEddyWinterSummerAvBrazilCurrents_',date_str,'.png'];
...
fid = fopen(outfile1,'w');
 ...
 fprintf(fid,['readme: generated by DL on', date_str, ...
     ' via code pltQekmanEddyWinterSummerAvBrazilCurrent_2020Feb14.m \n']);
 fprintf(fid,' \n');
