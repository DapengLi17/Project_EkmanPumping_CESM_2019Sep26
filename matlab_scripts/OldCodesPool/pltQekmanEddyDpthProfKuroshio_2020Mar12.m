...
lat_1d = lat_1d_raw(indxLat_KE);
indxLon_KE = find(lon_1d_raw >= lon_limits_KE(1) & lon_1d_raw <= lon_limits_KE(2));
lon_1d = lon_1d_raw(indxLon_KE);

z = DpthProf_su.z_wvel_ce; 

Q_li_prof_wt_KE = DpthProf_wt.Q_li(indxLon_KE,indxLat_KE,:); 
Q_li_prof_su_KE = DpthProf_su.Q_li(indxLon_KE,indxLat_KE,:); 
Q_nl_prof_wt_KE = DpthProf_wt.Q_nl(indxLon_KE,indxLat_KE,:);
Q_nl_prof_su_KE = DpthProf_su.Q_nl(indxLon_KE,indxLat_KE,:);
Q_ce_prof_wt_KE = DpthProf_wt.Q_ce(indxLon_KE,indxLat_KE,:);
Q_ce_prof_su_KE = DpthProf_su.Q_ce(indxLon_KE,indxLat_KE,:);
