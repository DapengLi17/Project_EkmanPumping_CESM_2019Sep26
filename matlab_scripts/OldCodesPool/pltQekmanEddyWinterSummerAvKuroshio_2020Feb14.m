...
outfile1 = ['../data_after_manipulation/QekmanEddyWinterSummerAvKuroshio_',date_str,'.txt'];
pic1 = ['../pics/QekmanEddyWinterSummerAvKuroshio_',date_str,'.png'];
