...
% descrip: matlab scripts plot wind stress (tau), Rossby number (Ro), 
% linear and nonlinear vertical Ekman pumping velocity, 
% and CESM total vertical velocity averaged over storm-free and 
% storms days. 
...
% extra notes:
% Stern nonlinear Ekman pumping velocity uses geostrophic vorticity instead
% of total vorticity. 
% =============
...
pic1 = ['../pics/SpaceAvWindStressTau_KE_',date_str,'.png'];
pic2 = ['../pics/TauRoWvelContours_KE_',date_str,'.png'];
...
ax6=subplot('Position',sbplt_posit(6,:));
  ...
  title(['W_{cesm} depth:',num2str(zU_raw(indxZ)),'m']); 
% ====================
