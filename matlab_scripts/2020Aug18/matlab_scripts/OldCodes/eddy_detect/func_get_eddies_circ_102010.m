            ...
            for ico  = 1:ncont ;              % ico - iterate through contours       
              ...
              if ( cont_d_km(ico).isopen == 0 && numel(cont_d_km(ico).xdata) > 3 ) 
                  ...
                  if ( eddy_test == 1 ) 
                      ...
                      taux_inon    =  diag.taux(inon);
                      taux_ave     =  tsnanmean(taux_inon);
                      tauy_inon    =  diag.tauy(inon);
                      tauy_ave     =  tsnanmean(tauy_inon);
...
%                       end
                      ...
                      eddy.taux(neddy) = taux_ave   ;
                      eddy.tauy(neddy) = tauy_ave   ;                      
