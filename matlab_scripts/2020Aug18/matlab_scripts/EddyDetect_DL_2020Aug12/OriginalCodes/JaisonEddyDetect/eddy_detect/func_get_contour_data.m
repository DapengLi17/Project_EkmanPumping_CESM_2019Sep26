function s=func_get_contour_data(c)
%
% Original name of this function was "contourdata"
%
...
%
%--------------------------------------------------------------------------
% Downloaded from : http://www.mathworks.com/matlabcentral/fileexchange/loadFile.do?objectId=15077&objectType=file
%   On May/24/2008
%--------------------------------------------------------------------------

if nargin<1 || ~isfloat(c) || size(c,1)~=2 || size(c,2)<4
   error('func_get_contour_data:rhs',...
