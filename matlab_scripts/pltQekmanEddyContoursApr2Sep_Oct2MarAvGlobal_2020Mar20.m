...
%   set(f1,'units','normalized','position',[0,0,1,1])
  ...
  bndry_lon_KE = [130 130 180 180 130];
  bndry_lat_KE = [48 25 25 48 48];
  bndry_lon_GS = [280 280 325 325 280];
  bndry_lat_GS = [45 27 27 45 45];
  bndry_lon_AR = [10 10 60 60 10];
  bndry_lat_AR = [-30 -50 -50 -30 -30];  
  bndry_lon_BC = [300 300 320 320 300];
  bndry_lat_BC = [-30 -55 -55 -30 -30];
...
% --- mark 4 western boundary current regions ---   
   m_line(bndry_lon_KE,bndry_lat_KE,'linewi',1.5,'color','k');
   m_text((2.*bndry_lon_KE(1)+bndry_lon_KE(3))./3,bndry_lat_KE(1)+8,'KE','fontsize',font_size,'FontWeight','bold');
   m_line(bndry_lon_GS,bndry_lat_GS,'linewi',1.5,'color','k');
   m_text((2.*bndry_lon_GS(1)+bndry_lon_GS(3))./3,bndry_lat_GS(1)+8,'GS','fontsize',font_size,'FontWeight','bold');
   m_line(bndry_lon_AR,bndry_lat_AR,'linewi',1.5,'color','k');
   m_text((2.*bndry_lon_AR(1)+bndry_lon_AR(3))./3,bndry_lat_AR(1)+8,'AR','fontsize',font_size,'FontWeight','bold');
   m_line(bndry_lon_BC,bndry_lat_BC,'linewi',1.5,'color','k');
   m_text((4.*bndry_lon_BC(1)+bndry_lon_BC(3))./5,bndry_lat_BC(1)+8,'BC','fontsize',font_size,'FontWeight','bold');   
% -----------------------------------------------
