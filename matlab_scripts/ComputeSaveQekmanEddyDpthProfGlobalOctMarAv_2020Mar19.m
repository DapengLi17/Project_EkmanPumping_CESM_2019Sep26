...
% --- summer seasons ---
header = 'This file was generated by DL via code ComputeSaveQekmanEddyDpthProfGlobalOctMarAv_2020Mar19.m';

MonSea = [01 02 03 10 11 12]; % winter
infileWekAv = ['../data_after_manipulation/TauKesaiRoWvelTempGlobalOctMarAv_2020Mar17.mat'];
infileWceAv = ['../raw_data/CESM_GlobalRegrid87_90MonthlyDat/WVEL/CESM_regrid_Oct-MarAv_WVEL_Global.nc'];
infileTwAv  = ['../raw_data/CESM_GlobalRegrid87_90MonthlyDat/TEMP/CESM_regrid_Oct-MarAv_TEMP_Global.nc'];

outfileQ = ['../data_after_manipulation/QekmanEddyDpthProfGlobalOctMarAv_',date_str,'.mat'];
% ----------------------
